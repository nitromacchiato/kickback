...
async function SubmitPlaylist(name,owner,spotifyID,href,school,image,description,followers){
   ...
   .finally(async () => {
    ...
    const UploadPlaylist = await prisma.$executeRaw`INSERT INTO playlists (name,owner,school,region,playlist_id,external_href,cover_image,followers,description) VALUES (${name}, ${owner}, ${school},${region} ,${spotifyID}, ${href}, ${image}, ${followers} ,${description});`
    .catch(e => {
        throw e
    })
   .finally(async () => {
