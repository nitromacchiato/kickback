...
async function SubmitPlaylist(name,owner,spotifyID,href,school,image){
    ...
    const UploadPlaylist = await prisma.$executeRaw`INSERT INTO playlists (name,owner,school,playlist_id,external_href,cover_image) VALUES (${name}, ${owner}, ${school}, ${spotifyID}, ${href}, ${image});`
    .catch(e => {
        throw e
    })
   .finally(async () => {
